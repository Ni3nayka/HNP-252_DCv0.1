...
// L298P amperka
#define HNR_252_DC_V0_1_PWM1 5
#define HNR_252_DC_V0_1_DIR1 4
#define HNR_252_DC_V0_1_PWM2 6
#define HNR_252_DC_V0_1_DIR2 7
...
class MotorShield {
  public:
    void setup() {
      ...
      #else
      pinMode(HNR_252_DC_V0_1_PWM1, OUTPUT);
      pinMode(HNR_252_DC_V0_1_DIR1, OUTPUT);
      pinMode(HNR_252_DC_V0_1_PWM2, OUTPUT);
      pinMode(HNR_252_DC_V0_1_DIR2, OUTPUT);
      #endif
      MotorShield::runs();
    }
    void run_1(int speed=0) {
      ...
      #else
      MotorShield::run_motor(HNR_252_DC_V0_1_PWM1, HNR_252_DC_V0_1_DIR1, speed);
      #endif
    }
    void run_2(int speed=0) {
      ...
      #else
      MotorShield::run_motor(HNR_252_DC_V0_1_PWM2, HNR_252_DC_V0_1_DIR2, speed);
      #endif
    }
